# Notes on VC_Tema 2: Adquisición, formación y representación de la imagen
...
- **Histograma**: El histograma de una imagen es la representación gráfica de la distribución de las intensidades de los píxeles. 
...
- **Umbralización**: Proceso de convertir una imagen en escala de grises en una imagen binaria (blanco y negro) mediante un valor de umbral.
...
- **CMOS**: Es más frecuente en dispositivos modernos, consume menos energía y es más económico, pero la calidad de imagen puede ser ligeramente inferior en comparación con los CCD.
